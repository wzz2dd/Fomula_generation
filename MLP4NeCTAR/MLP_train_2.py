...
def main():
    ...
    class AdversarialDatasetGPU(Dataset):
        ...
        def __getitem__(self, idx):
            ...
            # 3. 应用动态 Top-400 掩码 (GPU版)
            masked_disease = apply_dynamic_mask_torch(raw_disease, limit=400)
    ...
    # --- Training ---
    print("🚀 Initializing Top-400 Training (Full GPU)...")
